...
let projName = "NeXL.Worldbank"

let projDir = Path.Combine(sourceDir, projName)

let xlsmPath = Path.Combine(projDir, "Worldbank.xlsm") // path to Excel workbook
...
Target "Embed" (fun _ ->
        ...
        WorkbookPackager.EmbedProdID(xlsmPath, "1DFD0AFD-2A83-498A-A488-59D77697FD2A")
...
// to build or embed Ctrl,Shift & P, Fake, build, build/embed 
